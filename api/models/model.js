 ...
 */
   class DevilFruit {
    constructor(name, powerLevel, awakened, acquiredDate) {
        this.name = name;
...
/* Task 1 - Part 2. Replace these three instances of the example Class Resource with instances
   of your own class */
   model.add(new DevilFruit("Gomu Gomu no Mi", 100, true));
   model.add(new DevilFruit("Hie Hie no Mi", 90, false));
   model.add(new DevilFruit("Ope Ope no Mi", 95, true));
